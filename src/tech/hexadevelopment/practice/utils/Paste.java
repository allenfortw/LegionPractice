...
public class Paste {
	...
	private static String PASTEBIN_URL = "http://pastebin.com/api/api_post.php";
	...
	private void paste(List<String> lines, ExpireDate expire, String name, LinkCallback callback) {
		new BukkitRunnable() {
			...
			public void run() {
				...
				try {
					...
					String data = ("api_option=paste" +
							"&api_dev_key=" + URLEncoder.encode("6e390cbfb01f58f29b22196c1cf85520", "utf-8") +
	...
	public static enum ExpireDate {
		...
		private ExpireDate(String keyValue) {
			this.name = keyValue;
		}
